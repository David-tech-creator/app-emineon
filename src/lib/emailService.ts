...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p><strong>${invitation.inviterName}</strong> has invited you to access the <strong>${invitation.clientName}</strong> talent portal on Emineon ATS.</p>
      ...
      <p>Best regards,<br>
      <strong>The Emineon ATS Team</strong></p>
    </div>
...
${invitation.inviterName} has invited you to access the ${invitation.clientName} talent portal on Emineon ATS.
