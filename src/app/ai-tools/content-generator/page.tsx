          ...
          <Card>
            <CardContent className="p-10">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-semibold text-gray-900 mb-2">Import your resume to get started</h2>
                <p className="text-gray-600">Drag & drop a PDF/DOCX/TXT, or paste/type below. Dictation is supported.</p>
              </div>
