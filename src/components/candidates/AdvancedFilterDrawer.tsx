    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-2xl bg-white shadow-large rounded-l-2xl">
        <div className="flex h-full flex-col">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4 bg-gradient-to-r from-teal-600 via-primary-600 to-primary-800 rounded-tl-2xl">
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-white/20 backdrop-blur-sm rounded-lg shadow-medium">
            ...
            <button
              onClick={onClose}
              className="p-2 text-white/80 hover:text-white hover:bg-white/10 backdrop-blur-sm rounded-lg transition-colors"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
